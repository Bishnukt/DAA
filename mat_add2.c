...
Program- Write a program to add two matrices recursively.
*/
...
{
    int i, j;
    printf("Enter no. of rows in Matrix A & B to add: ");
    scanf("%d", &r);
    printf("Enter no. of columns in Matrix A & B to add: ");
    scanf("%d", &c);
